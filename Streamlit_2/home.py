...
def main():
    ...
    db = client["Enter your Database Name Here"]
    collection = db["Enter your Collection name Here"]
    ...
    if filtered_df.empty:
        ...
        def get_custom_icon_path(disaster_event):
            icon_paths = {
                "Avalanche": 'Enter your Image Location',
                "Blizzard": 'Enter your Image Location',
                "Cyclone": 'Enter your Image Location',
                "Drought": 'Enter your Image Location',
                "Earthquake": 'Enter your Image Location',
                "Flood": 'Enter your Image Location',
                "Heatwave": 'Enter your Image Location',
                "Hurricane": 'Enter your Image Location',
                "Landslide": 'Enter your Image Location',
                "Storm": 'Enter your Image Location',
                "Tornado": 'Enter your Image Location',
                "Tsunami": 'Enter your Image Location',
                "Volcano": 'Enter your Image Location',
                "Wildfire": 'Enter your Image Location',
            }
        ...
        # Map style options
        base_map_styles = {
            'Terrain': 'Enter map terrain style link',
            'Satellite': 'Enter map satellite style link',
            'Ocean': 'Enter map Ocean style link',
            'Detail': 'Enter map Detail style link'
        }
